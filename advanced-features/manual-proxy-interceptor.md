---
meta:
  title: "Parsley - Manual Proxy and Interceptor Implementation"
description: Learn how to manually implement proxies and interceptors in Parsley without using the CLI generator.
icon: file
label: Manual Proxies & Interceptors
tags: [ advanced, proxy, interceptor ]
order: 95
category:
  - Advanced Features
---
