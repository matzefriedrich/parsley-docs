---
meta:
  title: Parsley - Multi-Registry Aggregation
description: Combine multiple service registries into a single accessor for service resolution in Parsley.
icon: file
label: Multi-Registry Aggregation
