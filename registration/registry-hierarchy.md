---
meta:
  title: Parsley - Registry Hierarchy and Isolation
description: Understand how to use linked registries and scopes to manage service registration inheritance and isolation in Parsley.
icon: file
label: Linked- and Scoped-Registries
tags: [ registration, hierarchy, scope ]
order: 94
category:
  - Registration
---
