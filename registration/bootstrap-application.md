---
meta:
  title: Parsley - Bootstrap Application Lifecycle
description: Manage your application's lifecycle and dependency injection using the Parsley bootstrap package.
icon: file
label: Bootstrap Application
