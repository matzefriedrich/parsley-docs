---
meta:
  title: "Parsley - Walkthrough: Integrating Parsley with Chi for Dependency Injection"
description: Set up a Chi application using Parsley to create a modular, testable, and maintainable codebase.
icon: flame
label: "Walkthrough: Parsley Integration with Chi"
